...
└── package.json         
  ...
  },
  {
    ...
    description: `<div class=" max-w-3xl mx-auto">
      ...
      <p class="text-base mb-4 text-gray-600 dark:text-gray-300 text-justify ">
        A calculator built with React performs basic operations like addition, subtraction, multiplication, division, and percentage calculations.
      </p>

    <section class="mb-8">
      <h2 class="text-2xl font-semibold text-gray-600 dark:text-gray-300 mb-4">Features</h2>
      <ul class="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-400">
        <li><span class="font-medium"Calculation:</span> Have functionality to calculate mathematical operations on bases of input. </li>
        <li><span class="font-medium">History:</span> Preserve evaluted result.</li>
    ...
    <section class="mb-8">
      ...
      <ol class="list-decimal list-inside space-y-2 text-gray-700 dark:text-gray-400">
        <li>Added vertual Calculator to enter values and opertations.</li>
        <li>Preserve History of entered values and store it to for particular session.</li>
        <li>Evaluation is used to perferom different operation.</li>
        <li>After evaluation you will get the result.</li>
      </ol>
    </section>
