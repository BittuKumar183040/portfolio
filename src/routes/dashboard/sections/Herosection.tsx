        ...
        <motion.div
          ...
          <div className="text-lg md:text-xl lg:w-1/2 text-gray-700 opacity-70 text-center md:text-left dark:text-white">
            <motion.p
              variants={itemVariants}
            >
              I'm <span className="font-bold text-red-600">Bittu Kumar</span>, a passionate{' '}
              <span className="text-red-600">full stack developer</span> with over{' '}
              <span className="font-semibold text-red-600">2 years of experience</span> in the development field.
              I specialize in building{' '}
              <span className="font-semibold text-red-600">clean, functional websites</span>{' '}
