            ...
            <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
                <li>
                    ...
                    <div className="timeline-start mb-10 text-justify flex flex-col md:items-end h-full mt-14">
                        <time className="font-mono italic dark:text-white">January 2023</time>
                        <div className="text-lg font-black dark:text-gray-200">BosonQ Psi PVT. LTD.</div>
                        <p className=" text-md dark:text-gray-400">With 2 years of experience at this company, I play a key role in the software team, handling both frontend and backend
