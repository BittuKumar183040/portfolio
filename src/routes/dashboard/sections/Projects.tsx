...
const Projects = () => {
  return (
    <section className=" container mx-auto mt-4 mb-10">
        ...
        <h1 className="text-md md:text-md lg:text-xl font-bold text-red-600 text-center opacity-80 mb-6 text-shadow">List of all the project that I have build in past years.</h1>
