    ...
    <div className=" container px-2 h-screen flex flex-wrap gap-5 items-center">
      ...
      <div className=" bg-slate-200">
        ...
        <p className=" text-xl opacity-80">
          ...
          repudiandae sit accusamus ex eligendi, veniam culpa assumenda dolor
          possimus deserunt enim. Omnis non dolores doloremque ullam expedita
          saepe provident nobis.
        </p>
        <hr />
